...
class TestDictBase(unittest.TestCase):
    ...
    def test_destructor(self):
        ...
        self.assertIsNone(
            m_ref(),
            "Reference to object is still valid, something is wrong (using object instance instead of weakref.ref?)",
        )
    ...
    def test_bad_file_header_11(self):
        self._test_bad_file(
            b"\x80\x04\x95\x0d\x00\x00\x00\x00\x00\x00\x00J\x01\x00\x00\x000X\x01\x00\x00\x0001", ValueError
        )

    def test_bad_file_header_12(self):
        self._test_bad_file(
            b"\x80\x04\x95\x0d\x00\x00\x00\x00\x00\x00\x00J\x01\x00\x00\x000J\x01\x00\x00\x0011", ValueError
        )

    def test_bad_file_header_13(self):
        self._test_bad_file(
            b"\x80\x04\x95\x0d\x00\x00\x00\x00\x00\x00\x00J\x01\x00\x00\x000J\x01\x00\x00\x0001", ValueError
        )
